...
namespace DAYLY.Services
{
    public class MockEventData : IDataStore<Event>
    {
      //  public List<Note> Notess { get; }
        ...
        {
            Note testnot = new Note();
            testnot.Id = 1;
            testnot.URL = null;
            testnot.Description = "this is my description epic nice";
            Programme red = new Programme();
            red.HexColour = "green";
            Programme pink = new Programme();
            pink.HexColour = "pink";
            DateTime datetime1 = new DateTime(2020, 11, 19, 8, 30, 0);
            DateTime datetime2 = new DateTime(2020, 11, 21, 9, 30, 0);
            DateTime datetime3 = new DateTime(2020, 10, 23, 9, 30, 0);
            DateTime datetime4 = new DateTime(2020, 9, 18, 9, 30, 0);
            DateTime datetime5 = new DateTime(2020, 10, 20, 9, 30, 0);
            DateTime datetime6 = new DateTime(2020, 9, 22, 9, 30, 0);
...

            {
                ...
                //new Event { Id = "2", Name = "CAB303", Type = "tute", Date = datetime1, RepeatInterval = 1, AlertInterval=1, NoteEntry=null,SelectedProgramme=pink,AllDay=false,StartTime=span5, EndTime=span6,Location="P5" },
                 new Event { Id = 4, Name = "wednesday dude", Type = "tute", Date = datetime2, RepeatInterval = 1, AlertInterval=1, NoteId=2,ProgrammeId=1,AllDay=false,StartTime=span4, EndTime=span3,Location="P5" },
                 new Event { Id = 5, Name = "friyayayayayayay", Type = "tute", Date = datetime3, RepeatInterval = 2, AlertInterval=1, NoteId=1,ProgrammeId=1,AllDay=false,StartTime=span5, EndTime=span6,Location="P5" },
