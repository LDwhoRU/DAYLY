    ...
    public class MockEventData : IDataStore<Event>
    {
        ...
        public MockEventData()
        {
...

            {
                ...
                // new Event { Id = 4, Name = "wednesday dude", Type = "tute", Date = datetime2, RepeatInterval = 1, AlertInterval=1, NoteId=1,ProgrammeId=1,AllDay=false,StartTime=span4, EndTime=span3,Location="P5" },
